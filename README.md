# Piattaforma di simulazione campionati MotoGP con funzionalità predittive
...
## To-Do
- Ho appena fatto i CSV nuovi, fai che ora questi funzionino con il backend (aggiornalo)
