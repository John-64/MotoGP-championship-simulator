...
function Header() {
  return (
    <div className='sticky h-16 top-0 left-0 w-full px-5 shadow-md bg-black flex justify-between items-center text-sm'>
        <Link to="/" className="h-full w-auto flex justify-start items-center">
          <img src={motogp} alt="logo" className="h-2/4 hover:scale-110 transition duration-300 linear" />
        </Link>
